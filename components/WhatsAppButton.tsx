...
/**
 * Sticky WhatsApp CTA button — visible on all pages (bottom-right).
 * The WhatsApp green (#25D366) is intentionally kept — it is a globally
 * recognised brand colour and not subject to DAC's brand palette.
 */
